...
######################################################
# Date: 2022.10.18 파일 생성, 임도현
######################################################

# 함수 생성
# - 함수: 반복적으로 사용하는 기능을 코드로 묶어서 만듬
# - 사용: 함수이름으로 호출!
# - Python에서 ()이 붙어있으면 대부분 함수
# - 예: print(), pprint(), get(), get_text()...etc
# - 내장 함수: 파이썬 설치하면 기본적으로 제공
# - 외부 함수: 다른 개발자가 만들어 놓은 함수를 import 시켜 사용
...
# != 같지 않다
    ...
    if len(contents) != 0:  # 본문이 있는 경우에만 실행
        content = ''
